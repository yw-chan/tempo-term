/**
 * Vendored from catppuccin/vscode-icons (MIT). See ../../../../../assets/icons/catppuccin/LICENSE.
 * Do not hand-edit; re-copy from src/defaults/folderIcons.ts upstream to update.
 *
