/**
 * Vendored from catppuccin/vscode-icons (MIT). See ./LICENSE in the icon assets dir.
 * Do not hand-edit; re-copy from src/defaults/fileIcons.ts upstream to update.
 *
